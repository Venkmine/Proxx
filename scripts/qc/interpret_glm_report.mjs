    ...
    if (fs.existsSync(intentResultPath)) {
      try {
        ...
        if (intentResult.qc_invalid) {
          ...
          // Check if it's a visual change failure
          if (intentResult.visual_change_failure) {
            console.log('  VISUAL CHANGE GATE FAILURE')
            console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
            console.log('')
            console.log('A semantic action completed but produced no visible UI change.')
            console.log('This indicates the action may not be working correctly.')
            console.log('')
            console.log(`Action: ${intentResult.blocked_at}`)
            console.log(`Visual Diff: ${intentResult.diff_percent?.toFixed(2)}% (threshold: 5.0%)`)
