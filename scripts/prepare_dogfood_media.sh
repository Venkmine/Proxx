#!/bin/bash
# Prepare dogfood test media directory structure
# This script creates the directory structure and placeholder files
# YOU MUST replace placeholders with REAL media files

set -e

DOGFOOD_DIR="/Users/leon.grant/projects/Proxx/test_media/dogfood"

echo "🐕 Preparing dogfood test media directory..."

# Create directory structure
mkdir -p "$DOGFOOD_DIR/multi_clip_folder"
mkdir -p "$DOGFOOD_DIR/mixed_resolution"
mkdir -p "$DOGFOOD_DIR/broken_paths"
mkdir -p "$DOGFOOD_DIR/empty"

echo "📁 Directory structure created:"
echo "   $DOGFOOD_DIR/"
echo "   ├── multi_clip_folder/"
echo "   ├── mixed_resolution/"
echo "   ├── broken_paths/"
echo "   └── empty/"
...
echo ""
echo "✅ Directory structure ready: $DOGFOOD_DIR"
echo ""
echo "⚠️  NEXT STEPS (MANUAL):"
echo "   1. Copy REAL media files to $DOGFOOD_DIR"
echo "   2. Follow naming convention in $DOGFOOD_DIR/README.md"
echo "   3. Create broken_paths test cases"
echo "   4. Verify files with: ls -lh $DOGFOOD_DIR/**/*"
echo ""
echo "📖 See DOGFOOD_PLAN.md for full test procedures"
