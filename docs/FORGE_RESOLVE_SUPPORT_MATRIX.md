...
- **ProRes RAW**: ⚠️ **Proxy generation supported (Resolve-based)** ¹

> **¹ ProRes RAW Limitations:**
>
> - Tested for **proxy transcode only** (not as a creative or grading format)
> - No timeline or color control guarantees in DaVinci Resolve
> - Behavior may vary by Resolve version and ProRes RAW file variant
> - Not supported as a native editing or grading format in Resolve
>
...
| `prores_raw_sample` | ProRes RAW | ⚠️ PROXY ONLY | - | Studio | 20.3.1 |
