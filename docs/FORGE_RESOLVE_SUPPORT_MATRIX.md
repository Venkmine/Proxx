...
|--------|--------------|----------------|---------------|-------|
| **BRAW** (Blackmagic RAW) | ✅ | ✅ | `test_report_studio_20251230_204519.json` | Native support, verified 405MB output |
| **R3D** (RED RAW) | ⚠️ | ✅ | `test_report_studio_20251230_204519.json` | Studio verified (500MB output); Free has limited debayer |
| **ARRIRAW** (ARRI RAW) | ⚠️ | ⚠️ | `test_report_studio_20251230_204519.json` | **Sample-specific failure** - ARRICORE MXF failed import; variant-dependent |
| **X-OCN** (Sony RAW) | ⚠️ | ✅ | `test_report_studio_20251230_204519.json` | Venice 2 verified (3.9GB output); Free untested |
...
| **XAVC** (Sony) | ⚠️ | ✅ | Resolve | `test_report_studio_20251230_204519.json` | Burano verified (1.5GB output); Free untested |
...
| Test ID | Format | Status | Output Size | Edition |
|---------|--------|--------|-------------|---------|
| `braw_sample` | BRAW | ✅ PASSED | 405 MB | Studio |
| `r3d_sample` | R3D | ✅ PASSED | 500 MB | Studio |
| `xocn_sample` | X-OCN | ✅ PASSED | 3.9 GB | Studio |
| `xavc_sample` | XAVC | ✅ PASSED | 1.5 GB | Studio |
| `arriraw_sample` | ARRIRAW | ❌ FAILED | - | Studio |
| `prores_raw_sample` | ProRes RAW | ⏭️ SKIPPED | - | (blocked) |

**Resolve Version Tested:** 20.0.1 (Studio)

**Test Reports:**
- `forge-tests/reports/test_report_studio_20251230_204519.json` (primary evidence)
- `forge-tests/reports/test_report_studio_20251230_204726.json`
